    ...
    <nav className="w-full max-w-[1472px] bg-gray-100 border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-full">
      <div className="max-w-screen-2xl flex flex-auto flex-wrap items-center justify-between mx-auto py-4 px-8">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center p-2 w-max px-3 h-14 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        >
          <ul className="flex flex-col flex-1 font-medium p-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <button
